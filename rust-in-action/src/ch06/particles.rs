...
#[global_allocator]
static ALLOCATOR: ReporingAllocator = ReporingAllocator;
struct ReporingAllocator;

unsafe impl GlobalAlloc for ReporingAllocator {
